...
public class Message_StepDef {
    ...
    public void user_should_not_see_the_text_is_posted_as_a_link_successfully() {
        ...
        String actualMessageBody = activeStreamPage.getSentMessageBody(By.xpath("(//div[contains(@id,'feed-post-contentview-BLOG_POST-')])[1]/div"));
    ...
    public void user_pass_a_vimeo_video_url_into_the_inputbox_and_clicks_save_and_send_button() {
        ...
        BrowserUtils.waitForVisibility(activeStreamPage.insertVideoInputBox,10);
    ...
    public void user_should_see_the_vimeo_video_in_the_posted_message() {
        ...
        BrowserUtils.waitForPresenceOfElement(By.xpath("//div[@class='vp-video-wrapper transparent']"),10);

        WebElement videoVimeo = Driver.getDriver().findElement(By.xpath("//div[@class='vp-video-wrapper transparent']"));

        Assert.assertTrue(videoVimeo.isDisplayed());
    }
